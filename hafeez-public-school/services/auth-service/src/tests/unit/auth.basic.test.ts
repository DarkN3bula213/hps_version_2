...
import { AppError, IUser, UserType } from '../../types';
...
describe('AuthService Basic Tests', () => {
  ...
  describe('register', () => {
    ...
    it('should throw error when user already exists', async () => {
      ...
      mockUser.findOne.mockResolvedValue(existingUser as IUser);
  ...
  describe('login', () => {
    ...
    it('should throw error when user is inactive', async () => {
      ...
      mockUser.findOne.mockResolvedValue(mockUserDoc as IUser);
  ...
  describe('getUserById', () => {
    it('should return user when found', async () => {
      ...
      mockUser.findById.mockResolvedValue(mockUserDoc as IUser);
